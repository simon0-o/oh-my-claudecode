...
<tools>
External AI: `/team N:executor "task"`, `omc team N:codex|gemini|kimi "..."`, `omc ask <claude|codex|gemini|kimi>`, `/ccg`
...
Utilities: `ask-codex`, `ask-gemini`, `ask-kimi`, `cancel`, `note`, `learner`, `omc-setup`, `mcp-setup`, `hud`, `omc-doctor`, `omc-help`, `trace`, `release`, `project-session-manager`, `skill`, `writer-memory`, `ralph-init`, `configure-notifications`, `learn-about-omc` (`trace` is the evidence-driven tracing lane)
