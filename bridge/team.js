...
var VALID_CLI_AGENT_TYPES = /* @__PURE__ */ new Set(["claude", "codex", "gemini", "cursor", "kimi"]);
...
var TEAM_USAGE = `
Usage:
  omc team start --agent <claude|codex|gemini|cursor|kimi>[,<agent>...] --task "<task>" [--count N] [--name TEAM] [--cwd DIR] [--new-window] [--json]
